...
public class ThingsboardPublish implements Runnable {
	private String message;
	public static float x = 30;
    public static float y = 70;
	public float random_humi;
    public float random_temp;
    public static String temp			= "\"Temp\":"+x;
    public static String Humi			= "\"Humi\":"+y;
    ...
    {   	
        ...
        //data to be send
        ThingsboardPublish thread1 = new ThingsboardPublish("message1");
        //float x = 20;
    ...
    public ThingsboardPublish(String message){
    ...
    public void run() {
    	while(true) {
	        try {
	            ...
	            ThingsboardPublish.x += random_temp;
	            ThingsboardPublish.y += random_humi;
	            ThingsboardPublish.temp			= "\"Temp\":"+x;
	            ThingsboardPublish.Humi			= "\"Humi\":"+y;
	            ThingsboardPublish.both			= "{"+ThingsboardPublish.temp+","+ThingsboardPublish.Humi+"}"; 
